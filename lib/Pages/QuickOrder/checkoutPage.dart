      ...
      if (_appLifecycleState == AppLifecycleState.resumed &&
        ...
        if (numberRegExp.hasMatch(scannerResultData.result!!)) {
          ...
          if (scannedNumber.length == 9) {
            if (cardController.screenNumber == "3") {
                            ...
                            Container(
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  Text(
                                    '${cartController.afterDiscountAmount.value.toStringAsFixed(2)}',
                                    style: TextStyle(
                                        // color: Colors.green,
                                        fontSize: 18,
                                        fontWeight: FontWeight.w600),
                                      ...
                                      child: Form(
                                        child: Column(
                                          ...
                                          children: [
                                            ...
                                            SizedBox(height: 20.0),
                                            Obx(() => Text(
                                                  "Change:  ${cartController.change.value.toStringAsFixed(2)}",
                                                  style: TextStyle(
                                                      fontWeight:
                                                          FontWeight.bold,
                                                      fontSize: 16.0,
                                            ...
                                            GestureDetector(
                                              onTap: () {
                                                if (cartController
                                                  ...
                                                  cartController
                                                          .cashAmount.text =
                                                      "${cartController.remainingAmount.value}";
                                                }
                                                if (double.parse(cartController
                                                  ...
                                                  Get.snackbar('Message',
                                                      'Minimum ${cartController.remainingAmount.value} Cash needed',
                                    ...
                                    content: Padding(
                                      ...
                                      child: Form(
                                        child: Column(
                                          ...
                                          children: [
                                            Text(
                                              "Amount :  ${cartController.remainingAmount}",
                                              style: TextStyle(
                                              ...
                                              onTap: () {
                                                if (int.parse(
                                                    ...
                                                    cartController
                                                        ...
                                                        .value) {
                                                  Get.snackbar('Message',
                                                      'Amount cannot be greater than ${cartController.remainingAmount.value}',
                                                      backgroundColor:
                                                          Colors.red,
                                                      colorText: Colors.white);
                                                } else {
